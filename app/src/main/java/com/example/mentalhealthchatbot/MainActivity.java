...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText sendMessage = findViewById(R.id.message_back);
        final List<String> questions = new ArrayList<>();
        for (int i = 0; i < 3; i++) {
            questions.add("<insert question text>" + i);
        }
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                questions.add("<User response>");
                questions.add("<insert question text>");
        ...
        record.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast toast = Toast.makeText(getApplicationContext(), "Camera not available", Toast.LENGTH_SHORT);
                toast.show();
                questions.add("<insert question text>");
                adapter.notifyDataSetChanged();
            }
